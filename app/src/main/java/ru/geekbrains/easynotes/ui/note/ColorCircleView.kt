...
class ColorCircleView @JvmOverloads constructor(
    ...
    @Dimension(unit = PX)
    var radius: Float = context.dip(defRadiusDp).toFloat()
    ...
    @ColorRes
    var strokeColorRes: Int = R.color.color_text_secondary
        set(value) {
            field = value
    ...
    init {
        ...
        val defStrokeWidthPx = context.dip(defStrokeWidthDp).toFloat()
